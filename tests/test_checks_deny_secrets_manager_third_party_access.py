...
class TestDenySecretsManagerThirdPartyAccessCheck:
    ...
    def test_the_maps_are_keyed_in_sorted_order(
        ...
        """
        A map's keys do not record which secret named an account first.
        ...
        analyses = [
            SecretsPolicyAnalysis(
                ...
                has_non_account_principals=False,
                actions_by_account={
                    "555555555555": {"secretsmanager:DescribeSecret"},
                    "333333333333": {"secretsmanager:GetSecretValue"},
                },
            ),
            SecretsPolicyAnalysis(
                ...
                has_wildcard_principal=False,
                has_non_account_principals=False,
                actions_by_account={"444444444444": {"secretsmanager:GetSecretValue"}},
            ),
        ]
        ...
        with (
            ...
            assert list(summary["secrets_by_third_party_account"]) == [
                "333333333333",
                "444444444444",
                "555555555555",
            ]
            assert list(results_data["secrets_third_parties_can_access"][0]["actions_by_account"]) == [
                "333333333333",
                "555555555555",
            ]
