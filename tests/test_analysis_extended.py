...
class TestRunChecks:
    ...
    def test_run_checks_skip_existing_results(
        ...
        with (
            ...
            # Call pattern now (with 7 SCP checks and 4 RCP checks):
            # Account 1: all_scp_results_exist (7 calls for 7 SCP checks) → all True, all_rcp_results_exist (4 calls) → True, skip
            # Account 2: all_scp_results_exist (7 calls) → any False, all_rcp_results_exist (4 calls) → False
            ...
            # Total: 11 (Account 1) + 11 (Account 2 initial) + 7 (Account 2 SCP) + 4 (Account 2 RCP) = 33 calls
